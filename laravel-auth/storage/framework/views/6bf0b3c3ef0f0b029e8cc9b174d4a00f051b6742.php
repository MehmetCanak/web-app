            ...
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    <?php else: ?>
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    <a href="<?php echo e(url('/terms')); ?>" class="text-sm text-gray-500 underline ml-4">Terms</a>
                </div>
            <?php endif; ?>
...
<?php /**PATH /home/user/Documents/web-app/laravel-auth/resources/views/welcome.blade.php ENDPATH**/ ?>